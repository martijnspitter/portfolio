				...
				<div className="about__container">
					...
					<div className="about__text">
						...
						<div className="about__text--text">
							...
							<br />
							<p>
								I started with the front-end courses on Codecademy and Freecodecamp. I then took specialised courses on
								Udemy and edX in CSS, JavaScript, ReactJS en Redux and now have a solid understanding of these subjects.
								Along the way I also picked up some knowledge on MySQL and NodeJS / Express.
							</p>
						</div>
					</div>
				</div>
