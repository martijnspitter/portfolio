						...
						<div className="skills__content">
							<div className="skills__div">
								...
								<div className="skills__box">
									...
									<div className="skills__box--wrap">
										<p className="skills__box--text">
											Excellent knowledge on all the modern parts of CSS like grid layouts, flexboxes and animations as
											well as a good eye for modern design. Prefers working with SASS to be able to create reusable
											components.
										</p>
									</div>
								</div>
								...
								<div className="skills__box">
									...
									<div className="skills__box--wrap">
										<p className="skills__box--text">
											Specialised in ReactJS and creating reusable components. Prefers using Redux to manage state and
